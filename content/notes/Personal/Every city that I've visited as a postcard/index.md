...
I generated the full set of commands and ran them in parallel using [mprocs](https://github.com/pvolok/mprocs). I initially attempted to run all 24 jobs on [my laptop](/notes/hardware/laptop/), but ran out of RAM (running dozens of Python processes churning through tens of thousands of paths is memory-intensive, as it turns out). I spun up a `zellij` session on [my server](/notes/hardware/server/), and let it burn through the remaining posters. Much better![^serial]
...
`uv run src/maptoposter/__main__.py --location "-37.8136, 144.9631" -t Melbourne -s Australia -r 20000 -T terracotta -S 4x6 --dpi 600 -f fonts/NeoSans/NeoSansProRegular.OTF`
...
`uv run src/maptoposter/__main__.py --location "-33.8688, 151.2093" -t Sydney -s Australia -r 22000 -T terracotta -S 4x6 --dpi 600 -f "fonts/New Frank Regular.otf"`
...
`uv run src/maptoposter/__main__.py --location "-27.4698, 153.0251" -t Brisbane -s Australia -r 18000 -T terracotta -S 4x6 --dpi 600 -f fonts/Lato/Lato-Regular.ttf`
...
`uv run src/maptoposter/__main__.py --location "-34.9285, 138.6007" -t Adelaide -s Australia -r 15000 -T terracotta -S 4x6 --dpi 600 -f fonts/Archivo/static/Archivo-Regular.ttf`
...
`uv run src/maptoposter/__main__.py --location "35.6762, 139.6503" -t Tokyo -s Japan -r 25000 -T japanese_ink -S 4x6 --dpi 600 -f fonts/a-ttf-shin-go-pro/ATTFShinGoProRegular.ttf`
...
`uv run src/maptoposter/__main__.py --location "34.6937, 135.5023" -t Osaka -s Japan -r 18000 -T japanese_ink -S 4x6 --dpi 600 -f "fonts/Parisine/Parisine Regular/Parisine Regular.otf"`
...
`uv run src/maptoposter/__main__.py --location "35.0116, 135.7681" -t Kyoto -s Japan -r 10000 -T japanese_ink -S 4x6 --dpi 600 -f fonts/a-ttf-shin-go-pro/ATTFShinGoProRegular.ttf`
...
`uv run src/maptoposter/__main__.py --location "40.7580, -73.9855" -t "New York" -s "United States" -r 22000 -T midnight_blue -S 4x6 --dpi 600 -f fonts/helvetica-neue-5/HelveticaNeueRoman.otf`
...
`uv run src/maptoposter/__main__.py --location "38.9072, -77.0369" -t Washington -s "United States" -r 18000 -T midnight_blue -S 4x6 --dpi 600 -f fonts/helvetica-neue-5/HelveticaNeueRoman.otf`
...
`uv run src/maptoposter/__main__.py --location "37.7749, -122.4194" -t "San Francisco" -s "United States" -r 16000 -T midnight_blue -S 4x6 --dpi 600 -f fonts/helvetica-neue-5/HelveticaNeueRoman.otf`
...
`uv run src/maptoposter/__main__.py --location "59.3294, 18.0686" -t Stockholm -s Sweden -r 10000 -T ocean -S 4x6 --dpi 600 -f fonts/Meta-Font/meta-normal.ttf`
...
![Gothenburg](gothenburg.png)

`uv run src/maptoposter/__main__.py --location "57.7089, 11.9746" -t Gothenburg -s Sweden -r 10000 -T ocean -S 4x6 --dpi 600 -f "fonts/Univers Condensed/universcondensed_medium.ttf"`
...
`uv run src/maptoposter/__main__.py --location "59.9139, 10.7522" -t Oslo -s Norway -r 12000 -T blueprint -S 4x6 --dpi 600 -f fonts/frutiger/Frutiger.ttf`
...
`uv run src/maptoposter/__main__.py --location "60.3913, 5.3221" -t Bergen -s Norway -r 8000 -T blueprint -S 4x6 --dpi 600 -f fonts/frutiger/Frutiger.ttf`
...
![Christchurch](christchurch.png)

`uv run src/maptoposter/__main__.py --location "-43.5321, 172.6362" -t Christchurch -s "New Zealand" -r 12000 -T forest -S 4x6 --dpi 600 -f fonts/Space_Grotesk/static/SpaceGrotesk-Regular.ttf`
...
![Queenstown](queenstown.png)

`uv run src/maptoposter/__main__.py --location "-45.0312, 168.6626" -t Queenstown -s "New Zealand" -r 6000 -T forest -S 4x6 --dpi 600 -f fonts/Barlow/Barlow-Regular.ttf`
...
`uv run src/maptoposter/__main__.py --location "13.7563, 100.5018" -t Bangkok -s Thailand -r 20000 -T neon_cyberpunk -S 4x6 --dpi 600 -f fonts/Kanit/Kanit-Regular.ttf`
...
`uv run src/maptoposter/__main__.py --location "12.9716, 77.5946" -t Bangalore -s India -r 15000 -T bubblegum -S 4x6 --dpi 600 -f fonts/d-din/D-DIN.otf`
...
`uv run src/maptoposter/__main__.py --location "52.5200, 13.4050" -t Berlin -s Germany -r 20000 -T noir -S 4x6 --dpi 600 -f fonts/Fira_Sans_Condensed/FiraSansCondensed-Regular.ttf`
...
`uv run src/maptoposter/__main__.py --location "41.3874, 2.1686" -t Barcelona -s Spain -r 14000 -T sunset -S 4x6 --dpi 600 -f fonts/helvetica-neue-5/HelveticaNeueRoman.otf`
...
`uv run src/maptoposter/__main__.py --location "51.5074, -0.1278" -t London -s "United Kingdom" -r 24000 -T monochrome_blue -S 4x6 --dpi 600 -f fonts/johnston-itc/johnston-itc/johnstonitcstd-medium.otf`
...
`uv run src/maptoposter/__main__.py --location "38.1157, 13.3615" -t Palermo -s Italy -r 10000 -T warm_beige -S 4x6 --dpi 600 -f fonts/Fraunces/static/Fraunces_72pt-Regular.ttf`
...
`uv run src/maptoposter/__main__.py --location "47.3769, 8.5417" -t Zurich -s Switzerland -r 12000 -T feature_based -S 4x6 --dpi 600 -f fonts/frutiger/Frutiger.ttf`
...
`uv run src/maptoposter/__main__.py --location "48.8566, 2.3522" -t Paris -s France -r 18000 -T pastel_dream -S 4x6 --dpi 600 -f "fonts/Parisine/Parisine Regular/Parisine Regular.otf"`
...
`uv run src/maptoposter/__main__.py --location "50.0755, 14.4378" -t Prague -s "Czech Republic" -r 12000 -T autumn -S 4x6 --dpi 600 -f fonts/d-din/D-DIN.otf`
...
`uv run src/maptoposter/__main__.py --location "38.7223, -9.1393" -t Lisbon -s Portugal -r 12000 -T copper_patina -S 4x6 --dpi 600 -f fonts/Josefin_Sans/static/JosefinSans-Regular.ttf`
...
![Brussels](brussels.png)

`uv run src/maptoposter/__main__.py --location "50.8503, 4.3517" -t Brussels -s Belgium -r 12000 -T emerald -S 4x6 --dpi 600 -f fonts/univers/UniversRegular.ttf`
