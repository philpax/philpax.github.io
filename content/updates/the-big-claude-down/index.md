...
I assume you can see where this is going. I extracted the base documentation for Perchance as a Markdown document, raised my Claude Code hammer, and then I proceeded to [build a Rust interpreter for Perchance](https://github.com/philpax/perchance-interpreter/pull/1) <PrMeta start="2025-11-11" end="2025-11-12" add=5102 sub=2 />.
...
- [Build Perchance Interpreter Frontend with Live Preview](https://github.com/philpax/perchance-interpreter/pull/7) <PrMeta date="2025-11-12" add=5432 sub=0 />
- [Deploy frontend builds to GitHub Pages](https://github.com/philpax/perchance-interpreter/pull/8) <PrMeta date="2025-11-12" add=134 sub=60 />
- [Use ./ base for Vite](https://github.com/philpax/perchance-interpreter/pull/9) <PrMeta date="2025-11-12" add=1 sub=0 />
- [Import and export generators in Perchance](https://github.com/philpax/perchance-interpreter/pull/10) <PrMeta start="2025-11-12" end="2025-11-13" add=14599 sub=616 />
- [Add joinLists plugin support with hardcoded implementation](https://github.com/philpax/perchance-interpreter/pull/11) <PrMeta date="2025-11-13" add=460 sub=14 />
- [Debug color import and consumableList access](https://github.com/philpax/perchance-interpreter/pull/12) <PrMeta date="2025-11-13" add=211 sub=23 />
- [Update README](https://github.com/philpax/perchance-interpreter/pull/13) <PrMeta date="2025-11-15" add=127 sub=261 />
- [Implement missing README features](https://github.com/philpax/perchance-interpreter/pull/14) <PrMeta date="2025-11-16" add=731 sub=60 />
- [Add Ariadne diagnostics for all error types](https://github.com/philpax/perchance-interpreter/pull/15) <PrMeta start="2025-11-16" end="2025-11-17" add=1701 sub=578 />
- [Replace span fields with Spanned wrapper type](https://github.com/philpax/perchance-interpreter/pull/16) <PrMeta date="2025-11-17" add=569 sub=517 />
- [Implement missing functionality from README](https://github.com/philpax/perchance-interpreter/pull/17) <PrMeta date="2025-11-19" add=639 sub=25 />

![A trace view / debugger for a given Perchance generation, as part of the frontend](./perchance-interpreter-2.png)

- [Add generator execution tracing debugger](https://github.com/philpax/perchance-interpreter/pull/18) <PrMeta date="2025-11-19" add=1512 sub=85 />
- [Refactor evaluator into multiple modules](https://github.com/philpax/perchance-interpreter/pull/19) <PrMeta date="2025-11-19" add=3394 sub=3089 />
- [refactor: remove non-functional tree view from trace display](https://github.com/philpax/perchance-interpreter/pull/20) <PrMeta date="2025-11-23" add=17 sub=374 />
...
The integration method was simple in concept, but troublesome in execution - it was to [convert our existing Rust commands to Lua](https://github.com/philpax/paxcord/pull/5) <PrMeta start="2025-11-16" end="2025-12-03" add=1208 sub=844 />, making them much easier to iterate on and to add new commands with. This proved to be troublesome within the Claude Code Web framework, sa can be seen from the time taken: I had to iterate on the interface and test it extensively.
