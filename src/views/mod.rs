...
pub mod components;
pub use components::{Footnote, Link};
            ...
            <html lang="en-AU" class="w-[100vw]">
                ...
                <body class={format!("max-w-[860px] mx-auto text-[var(--color)] bg-[var(--background-color)] {FONT_STYLE} px-4 py-2 transition-all duration-200")}>
                    ...
                    <footer class="mt-4 mb-4 text-center text-xs text-[var(--color-secondary)] leading-relaxed">
                        <div>
                            "rss: "
                            <Link underline target={Route::BlogRss.url_path()} additional_classes={""}>
                                "blog"
                            </Link>
                            " · "
                            <Link underline target={Route::UpdatesRss.url_path()} additional_classes={""}>
                                "updates"
                            </Link>
                        </div>
                        <div>
                            "generated by "
                            <Link underline target={"https://github.com/philpax/philpax.github.io"} additional_classes={""}>
                                "paxsite"
                            </Link>
                            " on "
                        ...
                        <div>
                            <Link underline title={"Creative Commons 0"} target={"https://creativecommons.org/public-domain/cc0/"} additional_classes={""}>
                                "cc0"
                            </Link>" / public domain. do whatever you like! "
                            <Link underline target={Route::Credits.url_path()} additional_classes={""}>
                                "credits"
                            </Link>"."
                        </div>
                    </footer>
